...
const whatsAppEnv = {
  server: {
    ...
    WHATSAPP_ENABLE_LOCATION_MESSAGES: boolean.optional().default("true"),
    WHATSAPP_ENABLE_CONTACTS_MESSAGES: boolean.optional().default("true"),
    WHATSAPP_ENABLE_STICKER_MESSAGES: boolean.optional().default("true"),
    WHATSAPP_ENABLE_REACTION_MESSAGES: boolean.optional().default("true"),
