...
const recentProjects = [
  ...
  {
    name: "Tax Advisory Support Alpha",
    status: "DRAFT",
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-sm bg-white dark:bg-[#252525] border border-gray-200 dark:border-[#333] relative overflow-hidden group hover:border-gray-300 dark:hover:border-[#444] shadow-sm transition-colors">
              <div className="flex justify-between items-start mb-4">
                ...
                <span className="text-xs font-medium text-green-600 dark:text-green-500 bg-green-100 dark:bg-green-500/10 px-2 py-0.5 rounded">
                  ~ 12%
                </span>
              </div>
            ...
            <div className="p-6 rounded-sm bg-white dark:bg-[#252525] border border-gray-200 dark:border-[#333] group hover:border-gray-300 dark:hover:border-[#444] shadow-sm transition-colors">
              <div className="flex justify-between items-start mb-4">
                ...
                <span className="text-xs font-medium text-gray-600 dark:text-gray-400 bg-gray-100 dark:bg-gray-700/30 px-2 py-0.5 rounded">
                  Steady
                </span>
              </div>
              <div className="flex items-baseline gap-2">
            ...
            <div className="p-6 rounded-sm bg-white dark:bg-[#252525] border border-gray-200 dark:border-[#333] group hover:border-gray-300 dark:hover:border-[#444] shadow-sm transition-colors">
              <div className="flex justify-between items-start mb-4">
                ...
                <span className="text-xs font-medium text-red-600 dark:text-red-400 bg-red-100 dark:bg-red-400/10 px-2 py-0.5 rounded">
                  ↘ 3%
                </span>
              </div>
              <div className="flex items-baseline gap-2">
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-[#333]">
                  {recentProjects.map((project, idx) => (
                    <tr
                      key={idx}
                      className="group hover:bg-gray-50 dark:hover:bg-[#252525] transition-colors"
                    >
                      ...
                      <td className="py-4 px-6">
                        <span
                          className={`text-[10px] font-bold px-2 py-1 rounded-sm uppercase tracking-wide ${project.statusColor}`}
                        >
                          {project.status}
                        </span>
                      </td>
