...
import { WhatsAppListItemSettings } from "./WhatsAppListItemSettings";
...
export const WhatsAppListItemNode = ({ item, indices, isMouseOver }: Props) => {
  ...
  const updateItemSettings = (settings: Partial<WhatsAppListItem>) => {
  ...
  return (
    ...
    >
      <Popover.Trigger
        render={(props) => (
          <div className="flex px-3 py-2 justify-center w-full" {...props}>
