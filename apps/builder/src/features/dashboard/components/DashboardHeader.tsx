      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative hidden md:block group">
          <input
            ...
            className="bg-gray-50 dark:bg-[#262626] text-sm text-gray-900 dark:text-gray-200 rounded-sm pl-10 pr-4 py-2 w-64 border border-gray-200 dark:border-gray-700 focus:border-yellow-400 focus:ring-1 focus:ring-yellow-400 focus:outline-none transition-all placeholder:text-gray-400"
          />
